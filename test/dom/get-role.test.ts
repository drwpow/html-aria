...
import { getRole, getTagName, NO_CORRESPONDING_ROLE } from '../../src/index.js';
...
describe('getRole', () => {
  ...
  const testCases: [
    ...
    ['aside', { given: ['<aside>Aside</aside>', 'aside'], want: 'complementary' }],
    ['aside (in main)', { given: ['<main><aside></aside></main>', 'aside'], want: 'complementary' }],
    [
      'aside (in article in main)',
      { given: ['<main><article><aside></aside></article></main>', 'aside'], want: 'generic' },
    ],
    [
    ...
    ['aside (in <nav>)', { given: ['<nav><aside></aside></nav>', 'aside'], want: 'generic' }],
    [
      'aside[aria-label] (in nav)',
      { given: ['<nav><aside aria-label="Aside"></aside></nav>', 'aside'], want: 'complementary' },
    ],
    ['aside (in <section>)', { given: ['<section><aside></aside></section>', 'aside'], want: 'generic' }],
    [
      'aside[aria-label] (in section)',
      { given: ['<section><aside aria-label="Aside"></aside></section>', 'aside'], want: 'complementary' },
    ],
    [
